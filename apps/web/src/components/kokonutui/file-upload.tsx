								...
								{status === "idle" || status === "dragging" ? (
									...
									>
										...
										<div className="mb-6 space-y-2 text-center">
											<h3 className="font-semibold text-2xl text-gray-900 tracking-tight dark:text-white">
												Drag and drop or
											</h3>
											<p className="text-base text-gray-500 dark:text-gray-400">
												Upload PowerPoint files (.pptx, .ppt, .pptm)
										...
										<button
											...
											className="group flex w-4/5 items-center justify-center gap-3 rounded-lg bg-gray-100 px-8 py-4 font-semibold text-base text-gray-900 transition-all duration-200 hover:bg-gray-200 dark:bg-white/10 dark:text-white dark:hover:bg-white/20"
										>
											<span>Upload File</span>
											<UploadCloud className="h-5 w-5 transition-transform duration-200 group-hover:scale-110" />
										</button>
